...
const OVERLAY_CONFIGS: Record<string, Record<string, OverlayConfig>> = {
  ...
  'frf': {
   ...
   'U14': { overlays: [
        { x: 112, y: 530, page: 0, field: 'match_vs' },
        { x: 509, y: 460, page: 0, field: 'starting_hour' },
        { x: 416, y: 460, page: 0, field: 'formatted_date' },
        { x: 162, y: 460, page: 0, field: 'stadium_locality' },
        { x: 148, y: 432, page: 0, field: 'stadium_name' },
        { x: 166, y: 388, page: 0, field: 'referee_name_1' },
        { x: 167, y: 371, page: 0, field: 'assistant_referee_1' },
        { x: 168, y: 355, page: 0, field: 'assistant_referee_2' },
        { x: 165, y: 338, page: 0, field: 'fourth_official' },
        { x: 145, y: 781, page: 5, field: 'team_1' },
        { x: 162, y: 782, page: 6, field: 'team_2' },
        { x: 439, y: 388, page: 0, field: 'locality_field' },
        { x: 440, y: 372, page: 0, field: 'locality_field' },
        { x: 440, y: 355, page: 0, field: 'locality_field' },
        { x: 440, y: 338, page: 0, field: 'locality_field' }
      ],
    },
    'U15': { overlays: [
